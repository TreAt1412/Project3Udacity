...
def login (user, password):
    ...
    product_logo = driver.find_element_by_css_selector(path_product).text
    ...
    product_items = driver.find_elements_by_css_selector(path_items)
    ...
    for i in range(6):
        ...
        driver.find_elements_by_css_selector(path_to_item).find_element_by_xpath('..//..//..//div[@class="pricebar"]//button[@class="btn_primary btn_inventory"]').click()
    ...
    total_items_text = driver.find_element_by_css_selector(path_shopping_cart_badge).text
    ...
    for i in range(6):
        path_to_item = path_items + " > div[class='inventory_item_description'] > div[class='inventory_item_label'] > a[id='item_" + str(i) + "_title_link']"
        driver.find_elements_by_css_selector(path_to_item).find_element_by_xpath('..//..//..//div[@class="pricebar"]//button[@class="btn_secondary btn_inventory"]').click()
